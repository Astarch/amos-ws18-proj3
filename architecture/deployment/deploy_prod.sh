...
tar -zcvf ~/repo/backendRestDraft.tar.gz backendRestDraft/
...
scp -i AMOS_EC2_KEY.pem -o BatchMode=yes -o StrictHostKeyChecking=no ~/repo/backendRestDraft.tar.gz ubuntu@18.216.122.218:/home/ubuntu
rm ~/repo/backendRestDraft.tar.gz
