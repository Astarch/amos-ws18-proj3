...
const uploadDataToFirestore = (query, method, timerange, data) => {
  ...
  return axios.post('http://localhost:5000/pretrendr-d5939/us-central1/addWordcountData', uploadData)    
}

const getWordcountDataFromFirestore = (query, method) => {
    return axios.get(`http://localhost:5000/pretrendr-d5939/us-central1/getWordcountData?query=${query}&method=${method}`)    
  }
