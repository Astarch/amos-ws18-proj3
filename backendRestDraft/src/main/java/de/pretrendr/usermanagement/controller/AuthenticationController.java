...
public class AuthenticationController {
	...
	public ResponseEntity<User> loginPost(@RequestParam(value = "name") String username,
			@RequestParam(value = "passwd") String password) {
		return new ResponseEntity<User>(
				new User(username, password, "firstname", "lastname", "email", "address", "phone"), HttpStatus.OK);
	}
